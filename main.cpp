...
Purpose: The purpose of this program is to create a basic program that implements the fundamentals of programming. This is a program that asks the user for certain values and outputs a shape of their choice
*/
...
char enterCharacter(string inputLetter) {
    ...
    cin >> inputLetter;
    // While the input the user has put in has failed or is over one character, try again
