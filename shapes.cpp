...
to display the different shapes
*/
...
// Include the shapes.h file so that the functions can be used in the main.cpp
// file
#include "shapes.h"
...
*/
{
  // For the number of times that the user has inputted, output the user's
  // letter (height)
...
*/
{
  ...
  // letter (height)
  for (int i = 0; i < userNumber; i++) {
    // For the the same number of times as the current height being outputted,
    // output the user's letter
    for (int j = 0; j <= i; j++) {
